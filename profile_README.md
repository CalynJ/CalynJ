...
- **[Invoice Portfolio KPI Dashboard](https://github.com/CalynJ/Invoice-Portfolio-KPI-Dashboard)** - Interactive Power BI dashboard with KPI cards, aging/concentration visuals, and working drillthrough, completing the SQL → dbt → Power BI pipeline on the same invoice dataset.
